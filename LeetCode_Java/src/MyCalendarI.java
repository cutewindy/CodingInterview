...
public class MyCalendarI {
	...
	/**
	 * TreeMap
	 * T: O(log(n)) for each booking
	 * S: O(n) for all bookings
	 */
	...
	public static void main(String[] args) {
		...
		MyCalendarI result = new MyCalendarI();
		System.out.println(result.book(10,  20));
		System.out.println(result.book(15,  25));
		System.out.println(result.book(20,  30));
	}
