...
public class DesignCircularQueue {
	...
	public static void main(String[] args) {
		...
		DesignCircularQueue result = new DesignCircularQueue(3);
		System.out.println(result.enQueue(1));  // true
		System.out.println(result.enQueue(2));  // true
		System.out.println(result.enQueue(3));  // true   
		System.out.println(result.enQueue(4));  // false
		System.out.println(result.Rear());      // 3
		System.out.println(result.isFull());    // true
		System.out.println(result.deQueue());   // true
		System.out.println(result.enQueue(4));  // true
		System.out.println(result.Rear());      // 4
	}
