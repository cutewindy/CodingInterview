 ...
 * So function 0 totally execute 2 + 1 = 3 units of time, and function 1 totally execute 4 units of 
 * time.
 * Note:
...
public class ExclusiveTimeofFunctions {
	...
	public static void main(String[] args) {
		...
		ExclusiveTimeofFunctions result = new ExclusiveTimeofFunctions();
		System.out.println(Arrays.toString(result.exclusiveTimeofFunctions
				(2, Arrays.asList("0:start:0",
								  "1:start:2",
								  "1:end:5",
								  "0:end:6"))));
	}
