 ...
 * operations. You should find out how to add parenthesis to get the maximum result, and return the 
...
public class OptimalDivision {
	...
	public static void main(String[] args) {
		...
		OptimalDivision result = new OptimalDivision();
		System.out.println(result.optimalDivision(new int[] {1000,100,10,2}));
	}
