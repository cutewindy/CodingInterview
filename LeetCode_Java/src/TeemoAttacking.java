...
public class TeemoAttacking {
	...
	/**
	 * 
	 * @param int[] timeSeries, int duration
	 * @return int
	 * Time: O(n)
	 * Space: O(1)
	 */
	public int teemoAttacking(int[] timeSeries, int duration) {
	...
	public static void main(String[] args) {
		...
		TeemoAttacking result = new TeemoAttacking();
		System.out.println(result.teemoAttacking(new int[] {1,4} , 2));
	}
