...
public class SumofEvenNumbersAfterQueries {
	 ...
	 * Space: O(1)
	 */
	public int[] sumofEvenNumbersAfterQueries(int[] A, int[][] queries) {
	...
	public static void main(String[] args) {
		...
		SumofEvenNumbersAfterQueries result = new SumofEvenNumbersAfterQueries();
		System.out.println(Arrays.toString(result.sumofEvenNumbersAfterQueries(new int[] {1,2,3,4}, new int[][] {{1,0},{-3,1},{-4,0},{2,3}})));
	}
